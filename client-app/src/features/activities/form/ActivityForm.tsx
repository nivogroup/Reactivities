            ...
            <Grid.Column width={10}>
                <Segment clearing>
                    <Form onSubmit={handleSubmit}>
                        ...
                        <Form.TextArea rows={3} onChange={handleInputChange} 
                        name='description' placeholder='Description' value={activity.description} />

                        <Form.Input onChange={handleInputChange} 
                        name='category' placeholder='Category' value={activity.category} />
